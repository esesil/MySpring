...
<body bgcolor="#FFEFD5">
    ...
    <div class="comment-box">
        <form action="brInsert.do" id="replyForm" method="get">
            <input type="hidden" id="board_num" name="board_num" value="${board.board_num}"> <input type="hidden"
                id="page" name="page" value="${currentPage}"> <input type="hidden" id="comments" name="comments"
                value="">
            <p align="center">
                ...
                <textarea id="reply_contents" class="form-control" rows="6" cols="70%"
                    onfocus="if(this.value == 'Message') { this.value = ''; }" onblur="if(this.value == '') { this.value =
'Message'; }" placeholder="Message"></textarea>
